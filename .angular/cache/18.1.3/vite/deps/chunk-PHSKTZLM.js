...
var MatDrawerContent = class extends CdkScrollable {
...
MatDrawerContent.ɵfac = function MatDrawerContent_Factory(ɵt) {
  return new (ɵt || MatDrawerContent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(forwardRef(() => MatDrawerContainer)), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ScrollDispatcher), ɵɵdirectiveInject(NgZone));
};
MatDrawerContent.ɵcmp = ɵɵdefineComponent({
...
MatDrawer.ɵfac = function MatDrawer_Factory(ɵt) {
  return new (ɵt || MatDrawer)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusTrapFactory), ɵɵdirectiveInject(FocusMonitor), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(InteractivityChecker), ɵɵdirectiveInject(DOCUMENT, 8), ɵɵdirectiveInject(MAT_DRAWER_CONTAINER, 8));
};
MatDrawer.ɵcmp = ɵɵdefineComponent({
  type: MatDrawer,
...
MatDrawerContainer.ɵfac = function MatDrawerContainer_Factory(ɵt) {
  return new (ɵt || MatDrawerContainer)(ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ViewportRuler), ɵɵdirectiveInject(MAT_DRAWER_DEFAULT_AUTOSIZE), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8));
};
MatDrawerContainer.ɵcmp = ɵɵdefineComponent({
  type: MatDrawerContainer,
  ...
  dependencies: [MatDrawerContent, NgIf],
...
var MatSidenavContent = class extends MatDrawerContent {
  constructor(changeDetectorRef, container, elementRef, scrollDispatcher, ngZone) {
    super(changeDetectorRef, container, elementRef, scrollDispatcher, ngZone);
  }
};
MatSidenavContent.ɵfac = function MatSidenavContent_Factory(ɵt) {
  return new (ɵt || MatSidenavContent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(forwardRef(() => MatSidenavContainer)), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ScrollDispatcher), ɵɵdirectiveInject(NgZone));
};
MatSidenavContent.ɵcmp = ɵɵdefineComponent({
...
var MatSidenav = class extends MatDrawer {
  constructor() {
    super(...arguments);
...
MatSidenav.ɵfac = /* @__PURE__ */ (() => {
  let ɵMatSidenav_BaseFactory;
  return function MatSidenav_Factory(ɵt) {
    return (ɵMatSidenav_BaseFactory || (ɵMatSidenav_BaseFactory = ɵɵgetInheritedFactory(MatSidenav)))(ɵt || MatSidenav);
  };
})();
MatSidenav.ɵcmp = ɵɵdefineComponent({
  type: MatSidenav,
...
var MatSidenavContainer = class extends MatDrawerContainer {
};
MatSidenavContainer.ɵfac = /* @__PURE__ */ (() => {
  let ɵMatSidenavContainer_BaseFactory;
  return function MatSidenavContainer_Factory(ɵt) {
    return (ɵMatSidenavContainer_BaseFactory || (ɵMatSidenavContainer_BaseFactory = ɵɵgetInheritedFactory(MatSidenavContainer)))(ɵt || MatSidenavContainer);
  };
})();
MatSidenavContainer.ɵcmp = ɵɵdefineComponent({
  type: MatSidenavContainer,
  ...
  dependencies: [MatSidenavContent, NgIf],
  styles: [_c6],
  encapsulation: 2,
  changeDetection: 0
});
...
var MatSidenavModule = class {
};
MatSidenavModule.ɵfac = function MatSidenavModule_Factory(ɵt) {
  return new (ɵt || MatSidenavModule)();
};
MatSidenavModule.ɵmod = ɵɵdefineNgModule({
...
MatSidenavModule.ɵinj = ɵɵdefineInjector({
...
@angular/material/fesm2020/sidenav.mjs:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-PHSKTZLM.js.map
