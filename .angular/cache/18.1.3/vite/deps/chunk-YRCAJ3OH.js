...
AutofillMonitor.ɵfac = function AutofillMonitor_Factory(ɵt) {
  return new (ɵt || AutofillMonitor)(ɵɵinject(Platform), ɵɵinject(NgZone));
};
...
CdkAutofill.ɵfac = function CdkAutofill_Factory(ɵt) {
  return new (ɵt || CdkAutofill)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(AutofillMonitor));
};
CdkAutofill.ɵdir = ɵɵdefineDirective({
  type: CdkAutofill,
...
CdkTextareaAutosize.ɵfac = function CdkTextareaAutosize_Factory(ɵt) {
  return new (ɵt || CdkTextareaAutosize)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(DOCUMENT, 8));
};
CdkTextareaAutosize.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    ...
    enabled: [0, "cdkTextareaAutosize", "enabled"],
...
TextFieldModule.ɵfac = function TextFieldModule_Factory(ɵt) {
  return new (ɵt || TextFieldModule)();
};
TextFieldModule.ɵmod = ɵɵdefineNgModule({
  type: TextFieldModule,
  declarations: [CdkAutofill, CdkTextareaAutosize],
  exports: [CdkAutofill, CdkTextareaAutosize]
});
TextFieldModule.ɵinj = ɵɵdefineInjector({});
(() => {
...
MatInput.ɵfac = function MatInput_Factory(ɵt) {
  return new (ɵt || MatInput)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(NgControl, 10), ɵɵdirectiveInject(NgForm, 8), ɵɵdirectiveInject(FormGroupDirective, 8), ɵɵdirectiveInject(ErrorStateMatcher), ɵɵdirectiveInject(MAT_INPUT_VALUE_ACCESSOR, 10), ɵɵdirectiveInject(AutofillMonitor), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(MAT_FORM_FIELD, 8));
};
...
MatInputModule.ɵfac = function MatInputModule_Factory(ɵt) {
...
@angular/cdk/fesm2020/text-field.mjs:
  (**
   * @license
...
@angular/material/fesm2020/input.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YRCAJ3OH.js.map
