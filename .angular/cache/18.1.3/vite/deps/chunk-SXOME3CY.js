...
MatButtonToggleGroup.ɵfac = function MatButtonToggleGroup_Factory(ɵt) {
  return new (ɵt || MatButtonToggleGroup)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS, 8));
};
MatButtonToggleGroup.ɵdir = ɵɵdefineDirective({
...
var _MatButtonToggleBase = mixinDisableRipple(class {
});
var MatButtonToggle = class extends _MatButtonToggleBase {
...
MatButtonToggle.ɵfac = function MatButtonToggle_Factory(ɵt) {
  return new (ɵt || MatButtonToggle)(ɵɵdirectiveInject(MAT_BUTTON_TOGGLE_GROUP, 8), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusMonitor), ɵɵinjectAttribute("tabindex"), ɵɵdirectiveInject(MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS, 8));
};
MatButtonToggle.ɵcmp = ɵɵdefineComponent({
  ...
  template: function MatButtonToggle_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵattribute("tabindex", ctx.disabled ? -1 : ctx.tabIndex)("aria-pressed", ctx.checked)("name", ctx.name || null)("aria-label", ctx.ariaLabel)("aria-labelledby", ctx.ariaLabelledby);
      ɵɵadvance(5);
...
MatButtonToggleModule.ɵfac = function MatButtonToggleModule_Factory(ɵt) {
  return new (ɵt || MatButtonToggleModule)();
};
MatButtonToggleModule.ɵmod = ɵɵdefineNgModule({
  type: MatButtonToggleModule,
  declarations: [MatButtonToggleGroup, MatButtonToggle],
  imports: [MatCommonModule, MatRippleModule],
  exports: [MatCommonModule, MatButtonToggleGroup, MatButtonToggle]
});
MatButtonToggleModule.ɵinj = ɵɵdefineInjector({
...
@angular/material/fesm2020/button-toggle.mjs:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-SXOME3CY.js.map
