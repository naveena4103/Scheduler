...
_NgxSpinnerService.ɵfac = function NgxSpinnerService_Factory(ɵt) {
  return new (ɵt || _NgxSpinnerService)();
};
...
_SafeHtmlPipe.ɵfac = function SafeHtmlPipe_Factory(ɵt) {
  return new (ɵt || _SafeHtmlPipe)(ɵɵdirectiveInject(DomSanitizer, 16));
};
...
_NgxSpinnerComponent.ɵfac = function NgxSpinnerComponent_Factory(ɵt) {
  return new (ɵt || _NgxSpinnerComponent)(ɵɵdirectiveInject(NgxSpinnerService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NGX_SPINNER_CONFIG, 8));
};
...
_NgxSpinnerModule.ɵfac = function NgxSpinnerModule_Factory(ɵt) {
  return new (ɵt || _NgxSpinnerModule)();
};
