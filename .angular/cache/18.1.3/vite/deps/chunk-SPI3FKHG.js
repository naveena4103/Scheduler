...
function MatCalendarBody_tr_1_td_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelementStart(0, "td", 7)(1, "button", 8);
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("aria-label", item_r3.ariaLabel)("aria-disabled", !item_r3.enabled || null)("aria-pressed", ctx_r0._isSelected(item_r3.compareValue))("aria-current", ctx_r0.todayValue === item_r3.compareValue ? "date" : null);
    ɵɵadvance();
...
function MatCalendarBody_tr_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, MatCalendarBody_tr_1_td_1_Template, 2, 6, "td", 5)(2, MatCalendarBody_tr_1_td_2_Template, 5, 47, "td", 6);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function MatCalendar_mat_month_view_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener("activeDateChange", function MatCalendar_mat_month_view_2_Template_mat_month_view_activeDateChange_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      ɵɵtwoWayBindingSet(ctx_r1.activeDate, $event) || (ctx_r1.activeDate = $event);
      return ɵɵresetView($event);
    });
    ɵɵlistener("_userSelection", function MatCalendar_mat_month_view_2_Template_mat_month_view__userSelection_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("selected", ctx_r1.selected)("dateFilter", ctx_r1.dateFilter)("maxDate", ctx_r1.maxDate)("minDate", ctx_r1.minDate)("dateClass", ctx_r1.dateClass)("comparisonStart", ctx_r1.comparisonStart)("comparisonEnd", ctx_r1.comparisonEnd);
  }
}
function MatCalendar_mat_year_view_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener("activeDateChange", function MatCalendar_mat_year_view_3_Template_mat_year_view_activeDateChange_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext();
      ɵɵtwoWayBindingSet(ctx_r1.activeDate, $event) || (ctx_r1.activeDate = $event);
      return ɵɵresetView($event);
    });
    ɵɵlistener("monthSelected", function MatCalendar_mat_year_view_3_Template_mat_year_view_monthSelected_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext();
...
function MatCalendar_mat_multi_year_view_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener("activeDateChange", function MatCalendar_mat_multi_year_view_4_Template_mat_multi_year_view_activeDateChange_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext();
      ɵɵtwoWayBindingSet(ctx_r1.activeDate, $event) || (ctx_r1.activeDate = $event);
      return ɵɵresetView($event);
    });
    ɵɵlistener("yearSelected", function MatCalendar_mat_multi_year_view_4_Template_mat_multi_year_view_yearSelected_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext();
...
MatDatepickerIntl.ɵfac = function MatDatepickerIntl_Factory(ɵt) {
...
MatCalendarBody.ɵfac = function MatCalendarBody_Factory(ɵt) {
  return new (ɵt || MatCalendarBody)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
};
MatCalendarBody.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 2,
  vars: 2,
  consts: [["aria-hidden", "true", 4, "ngIf"], ["role", "row", 4, "ngFor", "ngForOf"], ["aria-hidden", "true"], [1, "mat-calendar-body-label"], ["role", "row"], ["class", "mat-calendar-body-label", 3, "paddingTop", "paddingBottom", 4, "ngIf"], ["role", "gridcell", "class", "mat-calendar-body-cell-container", 3, "width", "paddingTop", "paddingBottom", 4, "ngFor", "ngForOf"], ["role", "gridcell", 1, "mat-calendar-body-cell-container"], ["type", "button", 1, "mat-calendar-body-cell", 3, "click", "ngClass", "tabindex"], [1, "mat-calendar-body-cell-content", "mat-focus-indicator"], ["aria-hidden", "true", 1, "mat-calendar-body-cell-preview"]],
  template: function MatCalendarBody_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, MatCalendarBody_tr_0_Template, 3, 6, "tr", 0)(1, MatCalendarBody_tr_1_Template, 3, 2, "tr", 1);
    }
    if (rf & 2) {
  ...
  dependencies: [NgIf, NgForOf, NgClass],
...
var MatDateSelectionModel = class {
...
MatDateSelectionModel.ɵfac = function MatDateSelectionModel_Factory(ɵt) {
  ɵɵinvalidFactory();
};
MatDateSelectionModel.ɵprov = ɵɵdefineInjectable({
...
MatSingleDateSelectionModel.ɵfac = function MatSingleDateSelectionModel_Factory(ɵt) {
  return new (ɵt || MatSingleDateSelectionModel)(ɵɵinject(DateAdapter));
};
MatSingleDateSelectionModel.ɵprov = ɵɵdefineInjectable({
...
MatRangeDateSelectionModel.ɵfac = function MatRangeDateSelectionModel_Factory(ɵt) {
  return new (ɵt || MatRangeDateSelectionModel)(ɵɵinject(DateAdapter));
};
MatRangeDateSelectionModel.ɵprov = ɵɵdefineInjectable({
...
DefaultMatCalendarRangeStrategy.ɵfac = function DefaultMatCalendarRangeStrategy_Factory(ɵt) {
  return new (ɵt || DefaultMatCalendarRangeStrategy)(ɵɵinject(DateAdapter));
};
DefaultMatCalendarRangeStrategy.ɵprov = ɵɵdefineInjectable({
...
MatMonthView.ɵfac = function MatMonthView_Factory(ɵt) {
  return new (ɵt || MatMonthView)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(MAT_DATE_RANGE_SELECTION_STRATEGY, 8));
};
MatMonthView.ɵcmp = ɵɵdefineComponent({
  type: MatMonthView,
  ...
  dependencies: [MatCalendarBody, NgForOf],
  encapsulation: 2,
  changeDetection: 0
});
(() => {
...
MatMultiYearView.ɵfac = function MatMultiYearView_Factory(ɵt) {
  return new (ɵt || MatMultiYearView)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(Directionality, 8));
};
MatMultiYearView.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 5,
  vars: 7,
  consts: [["role", "grid", 1, "mat-calendar-table"], ["aria-hidden", "true", 1, "mat-calendar-table-header"], ["colspan", "4", 1, "mat-calendar-table-header-divider"], ["mat-calendar-body", "", 3, "selectedValueChange", "keyup", "keydown", "rows", "todayValue", "startValue", "endValue", "numCols", "cellAspectRatio", "activeCell"]],
...
MatYearView.ɵfac = function MatYearView_Factory(ɵt) {
  return new (ɵt || MatYearView)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(Directionality, 8));
};
MatYearView.ɵcmp = ɵɵdefineComponent({
  type: MatYearView,
  ...
  decls: 5,
  vars: 9,
  consts: [["role", "grid", 1, "mat-calendar-table"], ["aria-hidden", "true", 1, "mat-calendar-table-header"], ["colspan", "4", 1, "mat-calendar-table-header-divider"], ["mat-calendar-body", "", 3, "selectedValueChange", "keyup", "keydown", "label", "rows", "todayValue", "startValue", "endValue", "labelMinRequiredCells", "numCols", "cellAspectRatio", "activeCell"]],
...
MatCalendarHeader.ɵfac = function MatCalendarHeader_Factory(ɵt) {
  return new (ɵt || MatCalendarHeader)(ɵɵdirectiveInject(MatDatepickerIntl), ɵɵdirectiveInject(forwardRef(() => MatCalendar)), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), ɵɵdirectiveInject(ChangeDetectorRef));
};
MatCalendarHeader.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 11,
  vars: 10,
  consts: [[1, "mat-calendar-header"], [1, "mat-calendar-controls"], ["mat-button", "", "type", "button", "aria-live", "polite", 1, "mat-calendar-period-button", 3, "click"], ["viewBox", "0 0 10 5", "focusable", "false", 1, "mat-calendar-arrow"], ["points", "0,0 5,5 10,0"], [1, "mat-calendar-spacer"], ["mat-icon-button", "", "type", "button", 1, "mat-calendar-previous-button", 3, "click", "disabled"], ["mat-icon-button", "", "type", "button", 1, "mat-calendar-next-button", 3, "click", "disabled"]],
  template: function MatCalendarHeader_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ɵɵadvance(2);
      ɵɵattribute("aria-label", ctx.periodButtonLabel)("aria-describedby", ctx._buttonDescriptionId);
      ɵɵadvance();
      ɵɵattribute("id", ctx._buttonDescriptionId);
      ɵɵadvance();
...
MatCalendar.ɵfac = function MatCalendar_Factory(ɵt) {
  return new (ɵt || MatCalendar)(ɵɵdirectiveInject(MatDatepickerIntl), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), ɵɵdirectiveInject(ChangeDetectorRef));
};
MatCalendar.ɵcmp = ɵɵdefineComponent({
  type: MatCalendar,
  ...
  decls: 5,
  vars: 5,
  consts: [[3, "cdkPortalOutlet"], ["cdkMonitorSubtreeFocus", "", "tabindex", "-1", 1, "mat-calendar-content", 3, "ngSwitch"], [3, "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass", "comparisonStart", "comparisonEnd", "activeDateChange", "_userSelection", 4, "ngSwitchCase"], [3, "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass", "activeDateChange", "monthSelected", "selectedChange", 4, "ngSwitchCase"], [3, "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass", "activeDateChange", "yearSelected", "selectedChange", 4, "ngSwitchCase"], [3, "activeDateChange", "_userSelection", "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass", "comparisonStart", "comparisonEnd"], [3, "activeDateChange", "monthSelected", "selectedChange", "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass"], [3, "activeDateChange", "yearSelected", "selectedChange", "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass"]],
  template: function MatCalendar_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, MatCalendar_ng_template_0_Template, 0, 0, "ng-template", 0);
      ɵɵelementStart(1, "div", 1);
      ɵɵtemplate(2, MatCalendar_mat_month_view_2_Template, 1, 8, "mat-month-view", 2)(3, MatCalendar_mat_year_view_3_Template, 1, 6, "mat-year-view", 3)(4, MatCalendar_mat_multi_year_view_4_Template, 1, 6, "mat-multi-year-view", 4);
      ɵɵelementEnd();
    }
    if (rf & 2) {
  ...
  dependencies: [MatMonthView, MatYearView, MatMultiYearView, CdkPortalOutlet, CdkMonitorFocus, NgSwitch, NgSwitchCase],
...
var MatDatepickerContent = class extends _MatDatepickerContentBase {
...
MatDatepickerContent.ɵfac = function MatDatepickerContent_Factory(ɵt) {
  return new (ɵt || MatDatepickerContent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MatDateSelectionModel), ɵɵdirectiveInject(DateAdapter), ɵɵdirectiveInject(MAT_DATE_RANGE_SELECTION_STRATEGY, 8), ɵɵdirectiveInject(MatDatepickerIntl));
};
MatDatepickerContent.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatDatepickerContent_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵsyntheticHostListener("@transformPanel.done", function MatDatepickerContent_animation_transformPanel_done_HostBindingHandler() {
  ...
  dependencies: [MatCalendar, MatButton, CdkTrapFocus, NgClass, CdkPortalOutlet],
...
MatDatepickerBase.ɵfac = function MatDatepickerBase_Factory(ɵt) {
  return new (ɵt || MatDatepickerBase)(ɵɵdirectiveInject(Overlay), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(MAT_DATEPICKER_SCROLL_STRATEGY), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(MatDateSelectionModel));
};
MatDatepickerBase.ɵdir = ɵɵdefineDirective({
...
var MatDatepicker = class extends MatDatepickerBase {
};
MatDatepicker.ɵfac = /* @__PURE__ */ (() => {
  let ɵMatDatepicker_BaseFactory;
  return function MatDatepicker_Factory(ɵt) {
    return (ɵMatDatepicker_BaseFactory || (ɵMatDatepicker_BaseFactory = ɵɵgetInheritedFactory(MatDatepicker)))(ɵt || MatDatepicker);
  };
})();
MatDatepicker.ɵcmp = ɵɵdefineComponent({
  type: MatDatepicker,
...
var MatDatepickerInputBase = class {
...
MatDatepickerInputBase.ɵfac = function MatDatepickerInputBase_Factory(ɵt) {
  return new (ɵt || MatDatepickerInputBase)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
};
MatDatepickerInputBase.ɵdir = ɵɵdefineDirective({
...
var MatDatepickerInput = class extends MatDatepickerInputBase {
...
MatDatepickerInput.ɵfac = function MatDatepickerInput_Factory(ɵt) {
  return new (ɵt || MatDatepickerInput)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8), ɵɵdirectiveInject(MAT_FORM_FIELD, 8));
};
MatDatepickerInput.ɵdir = ɵɵdefineDirective({
...
var MatDatepickerToggleIcon = class {
};
MatDatepickerToggleIcon.ɵfac = function MatDatepickerToggleIcon_Factory(ɵt) {
  return new (ɵt || MatDatepickerToggleIcon)();
};
MatDatepickerToggleIcon.ɵdir = ɵɵdefineDirective({
...
MatDatepickerToggle.ɵfac = function MatDatepickerToggle_Factory(ɵt) {
  return new (ɵt || MatDatepickerToggle)(ɵɵdirectiveInject(MatDatepickerIntl), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵinjectAttribute("tabindex"));
};
MatDatepickerToggle.ɵcmp = ɵɵdefineComponent({
...
var MatDateRangeInputPartBase = class extends MatDatepickerInputBase {
...
MatDateRangeInputPartBase.ɵfac = function MatDateRangeInputPartBase_Factory(ɵt) {
  return new (ɵt || MatDateRangeInputPartBase)(ɵɵdirectiveInject(MAT_DATE_RANGE_INPUT_PARENT), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ErrorStateMatcher), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(NgForm, 8), ɵɵdirectiveInject(FormGroupDirective, 8), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
};
MatDateRangeInputPartBase.ɵdir = ɵɵdefineDirective({
...
var MatStartDate = class extends _MatDateRangeInputBase {
...
MatStartDate.ɵfac = function MatStartDate_Factory(ɵt) {
  return new (ɵt || MatStartDate)(ɵɵdirectiveInject(MAT_DATE_RANGE_INPUT_PARENT), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ErrorStateMatcher), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(NgForm, 8), ɵɵdirectiveInject(FormGroupDirective, 8), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
};
MatStartDate.ɵdir = ɵɵdefineDirective({
  type: MatStartDate,
...
var MatEndDate = class extends _MatDateRangeInputBase {
  constructor(rangeInput, elementRef, defaultErrorStateMatcher, injector, parentForm, parentFormGroup, dateAdapter, dateFormats) {
    super(rangeInput, elementRef, defaultErrorStateMatcher, injector, parentForm, parentFormGroup, dateAdapter, dateFormats);
...
MatEndDate.ɵfac = function MatEndDate_Factory(ɵt) {
  return new (ɵt || MatEndDate)(ɵɵdirectiveInject(MAT_DATE_RANGE_INPUT_PARENT), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ErrorStateMatcher), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(NgForm, 8), ɵɵdirectiveInject(FormGroupDirective, 8), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_DATE_FORMATS, 8));
};
MatEndDate.ɵdir = ɵɵdefineDirective({
  type: MatEndDate,
...
MatDateRangeInput.ɵfac = function MatDateRangeInput_Factory(ɵt) {
  return new (ɵt || MatDateRangeInput)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ControlContainer, 10), ɵɵdirectiveInject(DateAdapter, 8), ɵɵdirectiveInject(MAT_FORM_FIELD, 8));
};
MatDateRangeInput.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatDateRangeInput_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("id", null)("aria-labelledby", ctx._getAriaLabelledby())("aria-describedby", ctx._ariaDescribedBy)("data-mat-calendar", ctx.rangePicker ? ctx.rangePicker.id : null);
  ...
  template: function MatDateRangeInput_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ɵɵadvance(4);
      ɵɵtextInterpolate(ctx._getInputMirrorValue());
      ɵɵadvance();
...
var MatDateRangePicker = class extends MatDatepickerBase {
  _forwardContentValues(instance) {
...
MatDateRangePicker.ɵfac = /* @__PURE__ */ (() => {
  let ɵMatDateRangePicker_BaseFactory;
  return function MatDateRangePicker_Factory(ɵt) {
    return (ɵMatDateRangePicker_BaseFactory || (ɵMatDateRangePicker_BaseFactory = ɵɵgetInheritedFactory(MatDateRangePicker)))(ɵt || MatDateRangePicker);
  };
})();
MatDateRangePicker.ɵcmp = ɵɵdefineComponent({
...
MatDatepickerApply.ɵfac = function MatDatepickerApply_Factory(ɵt) {
  return new (ɵt || MatDatepickerApply)(ɵɵdirectiveInject(MatDatepickerBase));
};
MatDatepickerApply.ɵdir = ɵɵdefineDirective({
...
var MatDatepickerCancel = class {
  constructor(_datepicker) {
    this._datepicker = _datepicker;
  }
};
MatDatepickerCancel.ɵfac = function MatDatepickerCancel_Factory(ɵt) {
  return new (ɵt || MatDatepickerCancel)(ɵɵdirectiveInject(MatDatepickerBase));
};
MatDatepickerCancel.ɵdir = ɵɵdefineDirective({
...
var MatDatepickerActions = class {
...
MatDatepickerActions.ɵfac = function MatDatepickerActions_Factory(ɵt) {
  return new (ɵt || MatDatepickerActions)(ɵɵdirectiveInject(MatDatepickerBase), ɵɵdirectiveInject(ViewContainerRef));
};
MatDatepickerActions.ɵcmp = ɵɵdefineComponent({
...
var MatDatepickerModule = class {
};
MatDatepickerModule.ɵfac = function MatDatepickerModule_Factory(ɵt) {
  return new (ɵt || MatDatepickerModule)();
};
MatDatepickerModule.ɵmod = ɵɵdefineNgModule({
...
MatDatepickerModule.ɵinj = ɵɵdefineInjector({
...
@angular/material/fesm2020/datepicker.mjs:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-SPI3FKHG.js.map
