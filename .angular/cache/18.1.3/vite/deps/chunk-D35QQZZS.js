...
MatButton.ɵfac = function MatButton_Factory(ɵt) {
  return new (ɵt || MatButton)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusMonitor), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8));
};
...
MatAnchor.ɵfac = function MatAnchor_Factory(ɵt) {
  return new (ɵt || MatAnchor)(ɵɵdirectiveInject(FocusMonitor), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8), ɵɵdirectiveInject(NgZone, 8));
};
MatAnchor.ɵcmp = ɵɵdefineComponent({
  type: MatAnchor,
  ...
  hostBindings: function MatAnchor_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("tabindex", ctx.disabled ? -1 : ctx.tabIndex)("disabled", ctx.disabled || null)("aria-disabled", ctx.disabled.toString());
      ɵɵclassProp("_mat-animation-noopable", ctx._animationMode === "NoopAnimations")("mat-button-disabled", ctx.disabled);
    }
  },
  inputs: {
...
MatButtonModule.ɵfac = function MatButtonModule_Factory(ɵt) {
  return new (ɵt || MatButtonModule)();
};
...
MatButtonModule.ɵinj = ɵɵdefineInjector({
...
@angular/material/fesm2020/button.mjs:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-D35QQZZS.js.map
