...
_ActionsSubject.ɵfac = function ActionsSubject_Factory(ɵt) {
  return new (ɵt || _ActionsSubject)();
};
...
_ReducerManager.ɵfac = function ReducerManager_Factory(ɵt) {
  return new (ɵt || _ReducerManager)(ɵɵinject(ReducerManagerDispatcher), ɵɵinject(INITIAL_STATE), ɵɵinject(INITIAL_REDUCERS), ɵɵinject(REDUCER_FACTORY));
};
...
_ScannedActionsSubject.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function ScannedActionsSubject_Factory(ɵt) {
    return (ɵScannedActionsSubject_BaseFactory || (ɵScannedActionsSubject_BaseFactory = ɵɵgetInheritedFactory(_ScannedActionsSubject)))(ɵt || _ScannedActionsSubject);
  };
})();
...
_State.INIT = INIT;
_State.ɵfac = function State_Factory(ɵt) {
  return new (ɵt || _State)(ɵɵinject(ActionsSubject), ɵɵinject(ReducerObservable), ɵɵinject(ScannedActionsSubject), ɵɵinject(INITIAL_STATE));
};
...
_Store.ɵfac = function Store_Factory(ɵt) {
  return new (ɵt || _Store)(ɵɵinject(StateObservable), ɵɵinject(ActionsSubject), ɵɵinject(ReducerManager));
};
...
_StoreRootModule.ɵfac = function StoreRootModule_Factory(ɵt) {
  return new (ɵt || _StoreRootModule)(ɵɵinject(ActionsSubject), ɵɵinject(ReducerObservable), ɵɵinject(ScannedActionsSubject), ɵɵinject(Store), ɵɵinject(_ROOT_STORE_GUARD, 8), ɵɵinject(_ACTION_TYPE_UNIQUENESS_CHECK, 8));
};
...
_StoreFeatureModule.ɵfac = function StoreFeatureModule_Factory(ɵt) {
  return new (ɵt || _StoreFeatureModule)(ɵɵinject(_STORE_FEATURES), ɵɵinject(FEATURE_REDUCERS), ɵɵinject(ReducerManager), ɵɵinject(StoreRootModule), ɵɵinject(_ACTION_TYPE_UNIQUENESS_CHECK, 8));
};
...
_StoreModule.ɵfac = function StoreModule_Factory(ɵt) {
  return new (ɵt || _StoreModule)();
};
