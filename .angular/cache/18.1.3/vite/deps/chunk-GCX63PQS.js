...
function MatListOption_mat_pseudo_checkbox_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "mat-pseudo-checkbox", 5);
  }
  if (rf & 2) {
...
var _MatListBase = mixinDisabled(mixinDisableRipple(class {
}));
var _MatListItemMixinBase = mixinDisableRipple(class {
});
var MAT_LIST = new InjectionToken("MatList");
var MAT_NAV_LIST = new InjectionToken("MatNavList");
var MatNavList = class extends _MatListBase {
  constructor() {
    super(...arguments);
...
MatNavList.ɵfac = /* @__PURE__ */ (() => {
  let ɵMatNavList_BaseFactory;
  return function MatNavList_Factory(ɵt) {
    return (ɵMatNavList_BaseFactory || (ɵMatNavList_BaseFactory = ɵɵgetInheritedFactory(MatNavList)))(ɵt || MatNavList);
  };
})();
MatNavList.ɵcmp = ɵɵdefineComponent({
  type: MatNavList,
...
var MatList = class extends _MatListBase {
...
MatList.ɵfac = function MatList_Factory(ɵt) {
  return new (ɵt || MatList)(ɵɵdirectiveInject(ElementRef));
};
MatList.ɵcmp = ɵɵdefineComponent({
  type: MatList,
...
var MatListAvatarCssMatStyler = class {
};
MatListAvatarCssMatStyler.ɵfac = function MatListAvatarCssMatStyler_Factory(ɵt) {
  return new (ɵt || MatListAvatarCssMatStyler)();
};
MatListAvatarCssMatStyler.ɵdir = ɵɵdefineDirective({
  type: MatListAvatarCssMatStyler,
  selectors: [["", "mat-list-avatar", ""], ["", "matListAvatar", ""]],
  hostAttrs: [1, "mat-list-avatar"]
});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatListAvatarCssMatStyler, [{
    type: Directive,
    args: [{
...
var MatListIconCssMatStyler = class {
};
MatListIconCssMatStyler.ɵfac = function MatListIconCssMatStyler_Factory(ɵt) {
  return new (ɵt || MatListIconCssMatStyler)();
};
MatListIconCssMatStyler.ɵdir = ɵɵdefineDirective({
  type: MatListIconCssMatStyler,
  selectors: [["", "mat-list-icon", ""], ["", "matListIcon", ""]],
  hostAttrs: [1, "mat-list-icon"]
});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatListIconCssMatStyler, [{
    type: Directive,
    args: [{
...
MatListSubheaderCssMatStyler.ɵfac = function MatListSubheaderCssMatStyler_Factory(ɵt) {
  return new (ɵt || MatListSubheaderCssMatStyler)();
};
MatListSubheaderCssMatStyler.ɵdir = ɵɵdefineDirective({
...
var MatListItem = class extends _MatListItemMixinBase {
...
MatListItem.ɵfac = function MatListItem_Factory(ɵt) {
  return new (ɵt || MatListItem)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_NAV_LIST, 8), ɵɵdirectiveInject(MAT_LIST, 8));
};
MatListItem.ɵcmp = ɵɵdefineComponent({
  ...
  contentQueries: function MatListItem_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, MatListAvatarCssMatStyler, 5);
      ɵɵcontentQuery(dirIndex, MatListIconCssMatStyler, 5);
      ɵɵcontentQuery(dirIndex, MatLine, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx._avatar = _t.first);
  ...
  hostBindings: function MatListItem_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("mat-list-item-disabled", ctx.disabled)("mat-list-item-avatar", ctx._avatar || ctx._icon)("mat-list-item-with-avatar", ctx._avatar || ctx._icon);
    }
  },
  inputs: {
    disableRipple: "disableRipple",
...
var _MatSelectionListBase = mixinDisableRipple(class {
});
var _MatListOptionBase = mixinDisableRipple(class {
});
...
var MatSelectionListChange = class {
  constructor(source, option, options) {
    this.source = source;
    this.option = option;
    this.options = options;
  }
};
var MatListOption = class extends _MatListOptionBase {
...
MatListOption.ɵfac = function MatListOption_Factory(ɵt) {
  return new (ɵt || MatListOption)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(forwardRef(() => MatSelectionList)));
};
MatListOption.ɵcmp = ɵɵdefineComponent({
  type: MatListOption,
  ...
  hostBindings: function MatListOption_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("focus", function MatListOption_focus_HostBindingHandler() {
    ...
    if (rf & 2) {
      ɵɵattribute("aria-selected", ctx.selected)("aria-disabled", ctx.disabled)("tabindex", -1);
      ɵɵclassProp("mat-list-item-disabled", ctx.disabled)("mat-list-item-with-avatar", ctx._avatar || ctx._icon)("mat-primary", ctx.color === "primary")("mat-accent", ctx.color !== "primary" && ctx.color !== "warn")("mat-warn", ctx.color === "warn")("mat-list-single-selected-option", ctx.selected && !ctx.selectionList.multiple);
    }
  },
  inputs: {
    disableRipple: "disableRipple",
  ...
  decls: 7,
  vars: 5,
  consts: [["text", ""], [1, "mat-list-item-content"], ["mat-ripple", "", 1, "mat-list-item-ripple", 3, "matRippleTrigger", "matRippleDisabled"], [3, "state", "disabled", 4, "ngIf"], [1, "mat-list-text"], [3, "state", "disabled"]],
  template: function MatListOption_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c5);
      ɵɵelementStart(0, "div", 1);
      ɵɵelement(1, "div", 2);
      ɵɵtemplate(2, MatListOption_mat_pseudo_checkbox_2_Template, 1, 2, "mat-pseudo-checkbox", 3);
    ...
    if (rf & 2) {
      ɵɵclassProp("mat-list-item-content-reverse", ctx.checkboxPosition == "after");
      ɵɵadvance();
      ɵɵproperty("matRippleTrigger", ctx._getHostElement())("matRippleDisabled", ctx._isRippleDisabled());
      ɵɵadvance();
      ɵɵproperty("ngIf", ctx.selectionList.multiple);
    }
  },
  dependencies: [MatPseudoCheckbox, MatRipple, NgIf],
  encapsulation: 2,
  changeDetection: 0
});
(() => {
...
var MatSelectionList = class extends _MatSelectionListBase {
  constructor(_element, tabIndex, _changeDetector, _focusMonitor) {
    super();
    this._element = _element;
    this._changeDetector = _changeDetector;
  ...
  ngAfterContentInit() {
    ...
    this._keyManager = new FocusKeyManager(this.options).withWrap().withTypeAhead().withHomeAndEnd().skipPredicate(() => false).withAllowedModifierKeys(["shiftKey"]);
    if (this._value) {
...
MatSelectionList.ɵfac = function MatSelectionList_Factory(ɵt) {
  return new (ɵt || MatSelectionList)(ɵɵdirectiveInject(ElementRef), ɵɵinjectAttribute("tabindex"), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(FocusMonitor));
};
MatSelectionList.ɵcmp = ɵɵdefineComponent({
  type: MatSelectionList,
  ...
  hostBindings: function MatSelectionList_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ɵɵattribute("aria-multiselectable", ctx.multiple)("aria-disabled", ctx.disabled.toString())("tabindex", ctx._tabIndex);
    }
  },
  inputs: {
    disableRipple: "disableRipple",
  ...
  features: [ɵɵProvidersFeature([MAT_SELECTION_LIST_VALUE_ACCESSOR]), ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature],
  ngContentSelectors: _c0,
  decls: 1,
  vars: 0,
...
MatListModule.ɵfac = function MatListModule_Factory(ɵt) {
  return new (ɵt || MatListModule)();
};
MatListModule.ɵmod = ɵɵdefineNgModule({
  type: MatListModule,
...
MatListModule.ɵinj = ɵɵdefineInjector({
...
@angular/material/fesm2020/list.mjs:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-GCX63PQS.js.map
