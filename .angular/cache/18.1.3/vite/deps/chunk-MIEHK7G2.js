...
MatIconRegistry.ɵfac = function MatIconRegistry_Factory(ɵt) {
  return new (ɵt || MatIconRegistry)(ɵɵinject(HttpClient, 8), ɵɵinject(DomSanitizer), ɵɵinject(DOCUMENT, 8), ɵɵinject(ErrorHandler));
};
...
MatIcon.ɵfac = function MatIcon_Factory(ɵt) {
  return new (ɵt || MatIcon)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(MatIconRegistry), ɵɵinjectAttribute("aria-hidden"), ɵɵdirectiveInject(MAT_ICON_LOCATION), ɵɵdirectiveInject(ErrorHandler));
};
MatIcon.ɵcmp = ɵɵdefineComponent({
  type: MatIcon,
  selectors: [["mat-icon"]],
...
MatIconModule.ɵfac = function MatIconModule_Factory(ɵt) {
  return new (ɵt || MatIconModule)();
};
MatIconModule.ɵmod = ɵɵdefineNgModule({
  type: MatIconModule,
  declarations: [MatIcon],
  imports: [MatCommonModule],
  exports: [MatIcon, MatCommonModule]
});
MatIconModule.ɵinj = ɵɵdefineInjector({
...
@angular/material/fesm2020/icon.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MIEHK7G2.js.map
