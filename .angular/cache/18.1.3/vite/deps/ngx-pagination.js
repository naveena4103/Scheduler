...
PaginatePipe.ɵfac = function PaginatePipe_Factory(ɵt) {
  return new (ɵt || PaginatePipe)(ɵɵdirectiveInject(PaginationService, 16));
};
...
PaginationControlsDirective.ɵfac = function PaginationControlsDirective_Factory(ɵt) {
  return new (ɵt || PaginationControlsDirective)(ɵɵdirectiveInject(PaginationService), ɵɵdirectiveInject(ChangeDetectorRef));
};
...
PaginationControlsComponent.ɵfac = function PaginationControlsComponent_Factory(ɵt) {
  return new (ɵt || PaginationControlsComponent)();
};
...
NgxPaginationModule.ɵfac = function NgxPaginationModule_Factory(ɵt) {
  return new (ɵt || NgxPaginationModule)();
};
